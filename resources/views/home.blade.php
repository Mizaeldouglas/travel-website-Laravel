<x-base-html>
    <section class="banner" id="top" style="background-image: url({{url('assets/img/homepage-banner-image-1920x700.jpg')}});">
        <div class="container">
            <div class="row">
        ...
        <section class="our-services">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <img src="{{url('assets/img/about-1-720x480.jpg')}}" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="featured-item">
                            <div class="thumb">
                                <div class="thumb-img">
                                    <img src="{{url('assets/img/product-1-720x480.jpg')}}" alt="">
                                </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="featured-item">
                            <div class="thumb">
                                <div class="thumb-img">
                                    <img src="{{url('assets/img/product-2-720x480.jpg')}}" alt="">
                                </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="featured-item">
                            <div class="thumb">
                                <div class="thumb-img">
                                    <img src="{{url('assets/img/product-3-720x480.jpg')}}" alt="">
                                </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="featured-item">
                            <div class="thumb">
                                <div class="thumb-img">
                                    <img src="{{url('assets/img/product-4-720x480.jpg')}}" alt="">
                                </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="featured-item">
                            <div class="thumb">
                                <div class="thumb-img">
                                    <img src="{{url('assets/img/product-5-720x480.jpg')}}" alt="">
                                </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="featured-item">
                            <div class="thumb">
                                <div class="thumb-img">
                                    <img src="{{url('assets/img/product-6-720x480.jpg')}}" alt="">
                                </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="featured-item">
                            <div class="thumb">
                                <div class="thumb-img">
                                    <img src="{{url('assets/img/blog-1-720x480.jpg')}}" alt="">
                                </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="featured-item">
                            <div class="thumb">
                                <div class="thumb-img">
                                    <img src="{{url('assets/img/blog-2-720x480.jpg')}}" alt="">
                                </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="featured-item">
                            <div class="thumb">
                                <div class="thumb-img">
                                    <img src="{{url('assets/img/blog-3-720x480.jpg')}}" alt="">
                                </div>
            ...
            <div class="container">
                ...
                <div class="owl-carousel owl-theme">
                    <div class="item popular-item">
                        <div class="thumb">
                            <img src="{{url('assets/img/popular_item_1.jpg')}}" alt="">
                    ...
                    <div class="item popular-item">
                        <div class="thumb">
                            <img src="{{url('assets/img/popular_item_2.jpg')}}" alt="">
                            <div class="text-content">
                                <h4>John Doe</h4>
                                <span>"Lorem ipsum dolor sit amet, consectetur an adipisicing elit. Itaque, corporis nulla at quia quaerat."</span>
                            </div>
                    ...
                    <div class="item popular-item">
                        <div class="thumb">
                            <img src="{{url('assets/img/popular_item_3.jpg')}}" alt="">
                            <div class="text-content">
                                <h4>John Doe</h4>
                                <span>"Lorem ipsum dolor sit amet, consectetur an adipisicing elit. Itaque, corporis nulla at quia quaerat."</span>
                            </div>
                    ...
                    <div class="item popular-item">
                        <div class="thumb">
                            <img src="{{url('assets/img/popular_item_4.jpg')}}" alt="">
                            <div class="text-content">
                                <h4>John Doe</h4>
                                <span>"Lorem ipsum dolor sit amet, consectetur an adipisicing elit. Itaque, corporis nulla at quia quaerat."</span>
                            </div>
                    ...
                    <div class="item popular-item">
                        <div class="thumb">
                            <img src="{{url('assets/img/popular_item_5.jpg')}}" alt="">
                            <div class="text-content">
                                <h4>John Doe</h4>
                                <span>"Lorem ipsum dolor sit amet, consectetur an adipisicing elit. Itaque, corporis nulla at quia quaerat."</span>
                            </div>
